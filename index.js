...
////console.log(sheepSound)
const traditionalAnimalNames='bessie dolly sheep pig chicken'
const [bessie, ,dolly, babe, little]=farmAnimals.split(' ')
//const[cow, ,sheep, pig,chicken]=traditionalAnimalNames.split(' ')
console.log(traditionalAnimalNames)
const traditionalAnimalColor='blackAndWhite black pink'
